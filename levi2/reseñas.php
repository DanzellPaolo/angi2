...
$username = "root";
$password = "";
$dbname = "angy"; // Nombre de tu base de datos
...
$sql = "SELECT nombre_sugerencia, nombre_usuario, mensaje FROM sugerencias";
...
<header>
    ...
    <div class="container">
        <div class="image-section">
            <img src="fondo212.png" alt="Sugerencia">
        </div>
        <div class="text-section">
            <h2><?php echo htmlspecialchars($sugerencia['nombre_sugerencia']); ?></h2>
            <p><?php echo htmlspecialchars($sugerencia['mensaje']); ?></p>
            <p>Por: <?php echo htmlspecialchars($sugerencia['nombre_usuario']); ?></p>
        </div>
    </div>
<?php endforeach; ?>
